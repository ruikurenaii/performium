...
export async function calculatePerformance(plugin: PerformiumPlugin): Promise<number> {
  ...
  let performanceValue: number = ((angleBonus + starRatingBonus) / 2.05) + ((combinedValue * (1 + (starRating / 15))) / 29.5) + (roughnessPenalty * (3.1415926535 / 0.875)) + (factorBonus / (2.7182818284 * 1.05)) + (overallPenalty / -1.1) + (timeBonus / 9.8) + bonusValue + Math.pow(lengthBonus, 0.25) + Math.pow(burstScore, 0.25);
