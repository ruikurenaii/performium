...
export async function calculatePerformance(app: App): Promise<number> {
  ...
  const performanceValue: number = ((angleBonus + starRatingBonus) / 1.85) + (combinedValue * (starRating / 2)) + (roughnessPenalty * (3.1415926535 / 0.85)) + (factorBonus / 2.7182818284) + (overallPenalty / -1);
